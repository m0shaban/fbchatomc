        ...
        try:
            if "error" in response:
                ...
                if "401" in str(response['error']):
                    ...
                    return "للأسف، هناك مشكلة في الاتصال بنظام الذكاء الاصطناعي. يمكنك التواصل معنا مباشرة على رقم الهاتف: 01012345678 أو عبر البريد الإلكتروني: info@omalmisrservices.com وسيقوم فريقنا بالرد على استفسارك في أقرب وقت."
                elif "429" in str(response['error']):
                    # تجاوز حد الطلبات
                    return "عذراً، لدينا حالياً ضغط كبير على خدمة الرد الآلي. يمكنك معاودة المحاولة بعد قليل أو التواصل مباشرة مع فريق خدمة العملاء على الرقم: 01012345678."
                else:
                    # أي خطأ آخر
                    return "عذراً، واجهنا صعوبة تقنية مؤقتة. يمكنك معاودة الاستفسار مرة أخرى أو التواصل معنا مباشرة على الرقم: 01012345678 لمساعدتك فوراً."
